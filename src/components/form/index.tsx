                    ...
                    <Tabs defaultActiveKey="1">
                        <Tabs.TabPane tab="Principal" key="1">
                            ...
                            <Form.Item label="Qual é o tamanho do projeto que você deseja realizar?">
                                <Radio.Group optionType="button" buttonStyle="solid" className='custom-radio' onChange={changeInput} name="projectSize">
                            ...
                            <Form.Item label="Qual é o objetivo principal da sua arquitetura de software?">
                                <Radio.Group optionType="button" buttonStyle="solid" className='custom-radio' onChange={changeInput} name="architectureObjective">
                            ...
                            <Form.Item label="Qual é o nível de complexidade do seu sistema?" name="systemComplexity">
                                <Radio.Group optionType="button" buttonStyle="solid" className='custom-radio' onChange={changeInput} name="systemComplexity">
                            ...
                            <Form.Item label="Qual é o tipo de arquitetura de software que você está usando atualmente?" name="softwareArchitecture">
                                <Radio.Group optionType="button" buttonStyle="solid" className='custom-radio' onChange={changeInput} name="softwareArchitecture">
                        ...
                        <Tabs.TabPane tab="Security" key="2">
                            <Form.Item label="Qual é o nível de sensibilidade dos dados manipulados pelo seu sistema?">
                                <Radio.Group optionType="button" buttonStyle="solid" className='custom-radio' onChange={changeInput} name="securityArchitecture">
                                    <Radio value="low">Baixa</Radio>
                                    <Radio value="medium">Média</Radio>
                                    <Radio value="high">Alta</Radio>
                                    <Radio value="dontKnow">Não sei</Radio>
                            ...
                            <Form.Item label="Qual é a política de autenticação de usuários do seu sistema?" name="authenticationPolicy">
                                <Radio.Group optionType="button" buttonStyle="solid" className='custom-radio' onChange={changeInput} name="authenticationPolicy">
                            ...
                            <Form.Item
                                label="Qual é o nível de controle de acesso ao sistema?"
                                name="accessControlLevel"
                            >
                                <Radio.Group optionType="button" buttonStyle="solid" className='custom-radio' onChange={changeInput} name="accessControlLevel">
                            ...
                            <Form.Item
                                label="O seu sistema possui recursos de criptografia de dados?"
                                name="dataEncryption"
                            >
                                <Radio.Group optionType="button" buttonStyle="solid" className='custom-radio' onChange={changeInput} name="dataEncryption">
                            ...
                            <Form.Item
                                label="Qual é o nível de monitoramento e detecção de ameaças em tempo real?"
                                name="realTimeThreatDetection"
                            >
                                <Radio.Group optionType="button" buttonStyle="solid" className='custom-radio' onChange={changeInput} name="realTimeThreatDetection">
